...
> **Status: 0.52.0 (pre-1.0).** The full AGNOS spine is wired, the agentic loop closes, and thoth reads *and
...
accumulates from the less-trusted side. Multi-target (re-measured at 0.52.0 on the 6.6.4 pin): x86_64 Linux ships;
