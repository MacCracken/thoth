...
> **Status: 0.32.3 — the full spine wired, agentic tool-calling live, thoth reads *and writes* code (crash-safe),
...
> the relevant ones (semantic `mneme_search` injected into the turn, with the sources cited `[N]`), degrading to a
